...
class CatalogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post catalogs_url, params: { catalog: { category: @catalog.category, name: @catalog.name, privacy: @catalog.privacy } }
    end
  ...
  test "should update catalog" do
    patch catalog_url(@catalog), params: { catalog: { category: @catalog.category, name: @catalog.name, privacy: @catalog.privacy } }
